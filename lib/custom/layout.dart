  ...
  void showOverlay() {
    overlayEntry = OverlayEntry(
      builder: (BuildContext context) {
        // Cast widget.overlayBuilder to the correct function type
        final overlayBuilderFunction =
            widget.overlayBuilder as Widget Function(BuildContext);
        return overlayBuilderFunction(context);
      },
    );
